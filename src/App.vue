...
const firebaseConfig = {
  apiKey: 'AIzaSyBTINLEtzIPHOWPYzC7YFPpTNAD051qscs',
  authDomain: 'teamtrojan-7bc12.firebaseapp.com',
  databaseURL: 'https://teamtrojan-7bc12.firebaseio.com',
  storageBucket: 'teamtrojan-7bc12.appspot.com'
}
...
export default {
  ...
  mounted () {
    window.onblur = function() {
      document.title = "Be Aware about the world"
    }
    window.onfocus = function() {
      document.title = "Save The World Quiz"
    }
  }
};
</script>
